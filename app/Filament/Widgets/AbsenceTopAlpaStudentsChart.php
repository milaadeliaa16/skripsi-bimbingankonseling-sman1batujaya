...
class AbsenceTopAlpaStudentsChart extends ChartWidget
{
    protected ?string $heading = 'Siswa dengan Alpa Terbanyak (Bulan Ini)';

    protected ?string $description = 'Diurutkan berdasarkan total catatan alpa tertinggi.';
